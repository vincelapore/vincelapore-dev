const PORTFOLIO_CSS = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .project-card:hover { background: #16160f; }
  ...
  .cta-link:hover { background: var(--accent); color: var(--cream); }
  .cta-link:hover .cta-arrow { transform: translate(4px, -4px); }
  ...
  @media (max-width: 768px) {
    ...
    .work, .about, .cta { padding: 80px 24px; }
  ...
  return (
    <html lang="en">
      <head>
        ...
        <title>Vince Lapore — Developer</title>
        <link rel="preconnect" href="https://fonts.googleapis.com" />
        <link
          href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=DM+Mono:ital,wght@0,300;0,400;1,300&family=DM+Sans:wght@300;400;500&display=swap"
          rel="stylesheet"
        />
